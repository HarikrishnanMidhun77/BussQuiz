...
import  com.quizapp.hp.quiz.SMS_application;
...
public class SmsActivity extends  AppCompatActivity  implements  View.OnClickListener  {
        ...
        protected  void  onCreate(Bundle  savedInstanceState)  {
                        ...
                        if  (pref.isLoggedIn())  {
                                Intent  intent  =  new  Intent(SmsActivity.this, Ph_confirm_Activity.class
);
        ...
        public  void  onClick(View  view)  {
           ...
           */
                private  void  requestForSMS(final  String  name,  final  String  email,  final String  mobile)  {
                        ...
                        public  void  onErrorResponse(VolleyError  error)  {
                                        ...
                                        Toast.makeText(getApplicationContext(),
                                                       "Error_response:"+ error.getMessage(),  Toast.LENGTH_SHORT).show();
                                        progressBar.setVisibility(View.GONE);
                                }
                        })  {
                                /**
                        ...
                        SMS_application.getInstance().addToRequestQueue(strReq);
                }
                ...
                private  void  verifyOtp()  {
                        ...
                        if  (!otp.isEmpty())  {
                                ...
                                Toast.makeText(getApplicationContext(),  "Please  enter  the  OTP",
           ...
           */
                private  static  boolean  isValidPhoneNumber(String  mobile)  {
                      // String  regEx  =  "^[789]\\d{9}$";//  "^[0?9]{10}$";
                        return true; // mobile.matches(regEx);
                }
